    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('guardian_alternate_number', models.CharField(blank=True, max_length=15, null=True)),
                ...
                ('student_class', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='students', to='Users.class')),
            ],
        ),
    ]
